            ...
            <div class="row">
                <div class="col-lg-3">
                    <div class="shop__sidebar">
                        ...
                        <?php include $arrSETTINGS['dir_site'].'/include/search_2.inc.php'?>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <?php
                                if(!empty($arrPesquisa)){
                                    if($pageno != 1){

                                        
                                            echo '<a href="/pap/search.php?query='.$_GET['query'].'">1</a>';
                                        ...
                                        if($pageno != 2){
                                            ...
                                            echo '<a href="/pap/search.php?query='.$_GET['query'].'&pageno='.($pageno - 1).'">'.($pageno - 1).'</a>';
