...
$total_pages_sql = "SELECT COUNT(*) FROM favoritos WHERE idutilizador = '$id'";
...
<body>
    ...
    <section class="blog spad">
        <div class="container">
            <div class="row">
            <?php include $arrSETTINGS['dir_site'].'/include/favoritos.inc.php' ?>
            </div>
        </div>
    </section>
    <!-- Blog Section End -->
