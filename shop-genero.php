...
$total_pages_sql = "SELECT COUNT(*) FROM produtos WHERE genero='$gen'";
        ...
        <div class="container">
            ...
            <div class="col-lg-3">
                ...
                ?>
                    ...
                    WHERE A.estado = 1 AND C.genero='$genero' GROUP BY A.idprod $strSearchOrderBy LIMIT $offset, $no_of_records_per_page");
